...
In this program, the quadratic probing was NOT implemented.
...
Once the program has successfully compiled, type the following in the command prompt to run the program (while still staying in the same directory):
		         ...
		         java HashTable inputA5.txt outpuFile1.txt 

						
Where inputA5 is the .txt file that contains the data which you will create the hash table out of,
	
outputfile1 is the user chosen name of the .txt file which prints the statistics of the programs performance.
